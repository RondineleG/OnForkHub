...
public class Delete(ILogger<Delete> logger, IUseCase<long, bool> useCase) : BaseEndpoint<Category>, IEndpointAsync
{
    ...
    private readonly IUseCase<long, bool> _useCase = useCase;
