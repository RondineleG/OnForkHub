...
public class Delete(ILogger<Create> logger, IUseCase<CategoryRequestDto, Category> useCase) : BaseEndpoint<Category>, IEndpointAsync
{
    ...
    public Task<RequestResult> RegisterAsync(WebApplication app)
    {
        ...
        ConfigureEndpoint(
            ...
            .MapToApiVersion(V1)
            .WithDescription("Delete an existing category")
