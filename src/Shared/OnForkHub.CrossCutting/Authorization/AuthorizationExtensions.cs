...
public static class AuthorizationExtensions
{
    ...
    public static IServiceCollection AddRoleBasedAuthorization(this IServiceCollection services)
    {
        ...
        services.AddAuthorizationBuilder()
            ...
            .AddPolicy(Policies.RequireModerator, policy =>
                policy.AddRequirements(new RoleRequirement(Roles.Admin, Roles.Moderator)))
            .AddPolicy(Policies.RequireUser, policy =>
                policy.RequireAuthenticatedUser())
            .AddPolicy(Policies.RequirePremium, policy =>
                policy.AddRequirements(new RoleRequirement(Roles.Admin, Roles.Premium)))
            .AddPolicy(Policies.CanManageContent, policy =>
                policy.AddRequirements(new RoleRequirement(Roles.Admin, Roles.Moderator)))
            .AddPolicy(Policies.CanManageUsers, policy =>
                policy.AddRequirements(new RoleRequirement(Roles.Admin)))
            .AddPolicy(Policies.CanUploadVideos, policy =>
                policy.AddRequirements(new RoleRequirement(Roles.Admin, Roles.Moderator, Roles.User)))
            .AddPolicy(Policies.CanViewPremiumContent, policy =>
                policy.AddRequirements(new RoleRequirement(Roles.Admin, Roles.Premium)));
    ...
    /// <returns>The service collection for chaining.</returns>
    public static IServiceCollection AddCustomPolicy(
        ...
        params string[] allowedRoles)
    {
        ...
        services.AddAuthorizationBuilder()
            .AddPolicy(policyName, policy =>
                policy.AddRequirements(new RoleRequirement(allowedRoles)));
